...
_TEMPLATE_OPPORTUNITIES = [
    ...
    {
        "title": "Printify Studio — Etsy POD Expansion",
        "category": "Pitwall/POD",
        "revenue_score": 80.0,
        "automation_score": 70.0,
        ...
        "evidence": "Expand Printify print-on-demand catalogue with new motorsport designs on Etsy via Pitwall Classics.",
    },
    {
